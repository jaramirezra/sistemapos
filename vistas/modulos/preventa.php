...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box">
      ...
      <div class="box-body">
       <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
        ...
        <?php
          ...
          $respuesta = ControladorPreVenta::ctrRangoFechasPreventa($fechaInicial, $fechaFinal);
          ...
          foreach ($respuesta as $key => $value) {
           ...
           echo '<tr>
                  ...
                  <td>
                  	...
                  	<div class="btn-group">
                  	    <button class="btn btn-info btnImprimirFacturaPre" codigoPreventa="'.$value["codigo"].'">
                    	    <i class="fa fa-print"></i>
                  	</button>';

                      if($_SESSION["perfil"] == "Administrador"){
                      echo '<button class="btn btn-warning btnEditarPreventa" idPreVenta="'.$value["id"].'"><i class="fa fa-pencil"></i></button>';
      ...
      <?php
      $eliminarPreventa = new ControladorPreVenta();
      $eliminarPreventa -> ctrEliminarPreventa();
      ?>
