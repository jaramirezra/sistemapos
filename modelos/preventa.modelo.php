...
class ModeloPreventa{

	/*=============================================
	MOSTRAR PRE-VENTA
	=============================================*/

	static public function mdlMostrarPreventa($tabla, $item, $valor){
	...
	static public function mdlEditarPreventa($tabla, $datos){
	...
	static public function mdlEliminarPreventa($tabla, $datos){
	...
	static public function mdlRangoFechasPreventa($tabla, $fechaInicial, $fechaFinal){
	...
	/*=============================================
	SUMAR EL TOTAL DE PRE-VENTA
	=============================================*/

	static public function mdlSumaTotalPreventa($tabla){	
