...
class ModeloProductos{
	...
	static public function mdlMostrarProducto2($tabla, $item, $valor){
	...
	static public function mdlIngresarProducto($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(id_proveedores, id_categoria, codigo, descripcion, imagen, stock, precio_compra, precio_venta) VALUES (:id_proveedores, :id_categoria, :codigo, :descripcion, :imagen, :stock, :precio_compra, :precio_venta)");
		
		$stmt->bindParam(":id_proveedores", $datos["id_proveedores"], PDO::PARAM_INT);
	...
	static public function mdlCargarProducto($tabla, $datos){
